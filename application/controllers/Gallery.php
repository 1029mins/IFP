...
class Gallery extends CI_Controller {
    ...
    public function lists()
    {
        ...
        /*pagination*/
        if ($text1=="")
            $base_url = "/gallery/lists/page";
        else
            $base_url = "/gallery/lists/text1/$text1/page";
		...
		$data["menu"] ='aboutUs';
        $data["yearlist"] = $this->gallery_m->getlist_year();
        ...
        $data["list"] = $this->gallery_m->getlist($text1, $start, $limit, $regdate_year);
    ...
    public function view()
    {
       ...
       $this->load->view("main/main_header",$data);
       $this->load->view("main/gallery_view",$data);
       $this->load->view("main/main_footer");
    }
