...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
  ...
  <!--추가-->
  <a href="/admin_notice/add<?=$tmp ?>" class="d-sm-inline-block btn btn-sm btn-primary shadow-sm">
...
<script>
	...
	function find_text()
	{
		if (!form1.text1.value)
			form1.action="/admin_notice/lists/page";
		else
			form1.action="/admin_notice/lists/text1/" + form1.text1.value +"/page";
		form1.submit();
	}
  ...
  <table class="table table-bordered">
    <thead class="table-primary">
      <tr style="text-align:center;">
        ...
        <th scope="col">작성일</th>
        <th scope="col" style="color:#cc5843;">마감일</th>
        <th scope="col">작성자</th>
    ...
    <tbody>
        ...
        <tr style="text-align:center; background:white;">
            <!--<th scope="row"></th>-->
            <td><a href="/admin_notice/view/no/<?=$no;?><?=$tmp ?>"><?=iconv_substr($row->title,0,15,"utf-8"); ?></a></td>
