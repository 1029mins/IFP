...
?>
	  ...
	  <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between" style="background-color:#4e73df;">
	    ...
	    <div class="dropdown no-arrow">
	      ...
	      <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
	        <a class="dropdown-item" href="/admin_docs/del/no/<?=$no;?><?=$tmp;?>" onClick="return confirm('삭제할까요 ?');" style="color:red;">Delete</a>
	      </div>
	    </div>
	  </div>
	  <!-- Card Body -->
	  <div class="card-body row">
		...
		<?
		    ...
		    if ($row->pic) // 이미지가 있는 경우
			{
		        ...
		        echo("<center><img src='/images/docs/$row->pic' width='200' ></center>");
			}
			else {          // 이미지가 없는 경우
	...
	<div align="center">
		<!--<a href="/~sale/docs/edit" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">수정하기</a>&nbsp;-->
		<a href="/admin_docs/lists<?=$tmp;?>" class="d-sm-inline-block btn btn-sm btn-primary shadow-sm">목록</a>&nbsp;
