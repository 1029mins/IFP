...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
  ...
  <!--추가-->
  <a href="/admin_gallery/add<?=$tmp ?>" class="d-sm-inline-block btn btn-sm btn-primary shadow-sm">
...
<script>
	...
	function find_text()
	{
		if (!form1.text1.value)
			form1.action="/admin_gallery/lists/page";
		else
			form1.action="/admin_gallery/lists/text1/" + form1.text1.value +"/page";
		form1.submit();
	}
  ...
  <table class="table table-bordered">
    ...
    <tbody>
        ...
        <tr style="text-align:center; background:white;">
            <!--<th scope="row"></th>-->
            <td><a href="/admin_gallery/view/no/<?=$no;?><?=$tmp ?>"><?=iconv_substr($row->title,0,15,"utf-8"); ?></a></td>
